...
from ppars.apps.charge.views import ChargeList, ChargeDetail, ajax_charge_steps, \
    ...
    ajax_charge_create, ajax_charges_list, ajax_change_charge_note
...
urlpatterns = patterns('',
    ...
    url(r'^ajax_search/$', login_required(views.ajax_search), name="ajax_search"),
    url(r'^ajax_search_dropdown/$', login_required(views.ajax_search_dropdown), name="ajax_search_dropdown"),
    ...
    #url(r'^twilio-request/$', views.twilio_request, name='twilio_request'),
    url(r'^twilio-response/$', views.twilio_response, name='twilio_response'),
    ...
    url(r'^ajax_skip_next_refill/$', login_required(views.ajax_skip_next_refill), name='skip_next_refill'),
